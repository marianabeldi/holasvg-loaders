...
/******/ 			var chunk = require("./" + ({"1":"components/codes","2":"components/effects","3":"components/fill-color","4":"components/footer","5":"components/loader-container","6":"components/shapes","7":"components/share","8":"components/styles","9":"pages/index"}[chunkId]||chunkId) + ".js");
...
const _2732e8a2 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 9).then(__webpack_require__.bind(null, 66)));
...
var prism_material_oceanic = __webpack_require__(21);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=357b7448&
var defaultvue_type_template_id_357b7448_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-wrapper"},[_vm._ssrNode("<b class=\"top\">"+_vm._ssrEscape(_vm._s(_vm.headerText))+"</b> "),_c('Nuxt')],2)}
var defaultvue_type_template_id_357b7448_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=357b7448&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_357b7448_render,
  defaultvue_type_template_id_357b7448_staticRenderFns,
  false,
...
const components = {
  Footer: () => __webpack_require__.e(/* import() | components/footer */ 4).then(__webpack_require__.bind(null, 36)).then(c => wrapFunctional(c.default || c)),
  Codes: () => __webpack_require__.e(/* import() | components/codes */ 1).then(__webpack_require__.bind(null, 53)).then(c => wrapFunctional(c.default || c)),
  Effects: () => __webpack_require__.e(/* import() | components/effects */ 2).then(__webpack_require__.bind(null, 58)).then(c => wrapFunctional(c.default || c)),
  FillColor: () => __webpack_require__.e(/* import() | components/fill-color */ 3).then(__webpack_require__.bind(null, 55)).then(c => wrapFunctional(c.default || c)),
  LoaderContainer: () => __webpack_require__.e(/* import() | components/loader-container */ 5).then(__webpack_require__.bind(null, 57)).then(c => wrapFunctional(c.default || c)),
  Shapes: () => __webpack_require__.e(/* import() | components/shapes */ 6).then(__webpack_require__.bind(null, 56)).then(c => wrapFunctional(c.default || c)),
  Share: () => __webpack_require__.e(/* import() | components/share */ 7).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c)),
  Styles: () => __webpack_require__.e(/* import() | components/styles */ 8).then(__webpack_require__.bind(null, 54)).then(c => wrapFunctional(c.default || c))
};
      ...
      if (effectid === this.$state.effectActive[i]) {
        ...
        for (let lm = 1; lm <= this.$state.amount; lm++) {
          ...
          for (let i = 0; i < this.$state.effectActive.length; i++) {
            ...
            if (effect === "opacity") {
              animation = `<animate attributeName="${effect}" values="0;1;0" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite"></animate>`;
            }

            if (effect === "translate") {
              animation = `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0 0" to="10"></animateTransform>`;
            }

            if (effect === "rotate") {
              animation = `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0 50 50" to="360 0 0"></animateTransform>`;
            }

            if (effect === "scale") {
              animation = `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0" to="1.2"></animateTransform>`;
            }

            if (effect === "skewX") {
              animation = `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0" to="20"></animateTransform>`;
            }
      ...
      if (effectid === obj.id) {
        ...
        for (let lm = 1; lm <= this.$state.amount; lm++) {
          ...
          const newSmilLine = this.$state.effectActive.map(effect => {
            ...
            if (effect === "opacity") {
              return `<animate attributeName="${effect}" values="0;1;0" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite"></animate>`;
            }

            if (effect === "translate") {
              return `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0 0" to="10"></animateTransform>`;
            }

            if (effect === "rotate") {
              return `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0 50 50" to="360 0 0"></animateTransform>`;
            }

            if (effect === "scale") {
              return `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0" to="1.2"></animateTransform>`;
            }

            if (effect === "skewX") {
              return `<animateTransform attributeName="transform" type="${effect}" additive="sum" dur="${this.$state.duration}s" begin="${delaybe.toFixed(2)}s" repeatCount="indefinite" from="0" to="20"></animateTransform>`;
            }
          }).join('');
...
function loaderSassFunction() {
  ...
  for (let ls = 0; ls < this.$state.effectActive.length; ls++) {
    this.$state.loaderSass.push(`${this.$state.duration}s $i * ${(1 / this.$state.amount * this.$state.duration).toFixed(2)}s ${this.$state.effectActive[ls]}Loader infinite,`);
  }
}
...
function computedAnimationFunction() {
  ...
  for (let i = 1; i <= this.$state.amount; i++) {
    const newLine = this.$state.effectActive.map(effect => {
      const delay = i / this.$state.amount * this.$state.duration;
      return `${this.$state.duration}s ${delay}s ${effect}Loader infinite`;
    });
...
/* harmony default export */ var globalObject = (({
  ...
  inject('state', external_vue_default.a.observable(state)), // inject('getSmilCode', Vue.observable(getSmilCode))
  inject('loaderCurrentFunction', external_vue_default.a.observable(loaderCurrentFunction));
  inject('loaderSmilFunction', external_vue_default.a.observable(loaderSmilFunction));
  inject('loaderSassFunction', external_vue_default.a.observable(loaderSassFunction));
  inject('computedAnimationFunction', external_vue_default.a.observable(computedAnimationFunction));
