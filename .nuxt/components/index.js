...
export { default as L2 } from '../../components/L2.vue'
...
export const LazyL2 = import('../../components/L2.vue' /* webpackChunkName: "components/l2" */).then(c => wrapFunctional(c.default || c))
