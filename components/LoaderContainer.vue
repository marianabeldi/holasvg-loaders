      ...
      >
        <defs>
          ...
          <template v-if="$state.shapeActive === 'rect'">
            <rect id="spinner" x="15" y="40" width="10" height="20" rx="2" ry="2"/>
          </template>
        ...
        <template v-if="$state.codeActive === 'SMIL'">
          <use :key="`smilSpinner${i}`" v-for="(singleSpinner, i) in 12" xlink:href="#spinner" :transform="`rotate(${i * 30} 50 50)`">
        ...
        <template v-if="$state.codeActive === 'SASS' && $state.computedAnimationBoth.length > 0">
          <g
    ...
    <template v-if="$state.styleActive === 'inline1'">
      ...
      >
        <defs>
          ...
          <template v-if="$state.shapeActive === 'rect'">
            <rect id="inline" x="10" y="45" width="16" height="10" rx="2" ry="2"/>
          </template>
          <template v-if="$state.shapeActive === 'bar'">
            <rect id="inline" x="15" y="40" width="10" height="20" rx="2" ry="2"/>
          </template>
        </defs>
