...
import nuxt_plugin_plugin_11972224 from 'nuxt_plugin_plugin_11972224' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginclient_5cb33ba0 from 'nuxt_plugin_pluginclient_5cb33ba0' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_7b26a5b0 from 'nuxt_plugin_pluginserver_7b26a5b0' // Source: ./content/plugin.server.js (mode: 'server')
import nuxt_plugin_googleanalytics_4f1a8cac from 'nuxt_plugin_googleanalytics_4f1a8cac' // Source: ./google-analytics.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_11972224 === 'function') {
    await nuxt_plugin_plugin_11972224(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_5cb33ba0 === 'function') {
    await nuxt_plugin_pluginclient_5cb33ba0(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_7b26a5b0 === 'function') {
    await nuxt_plugin_pluginserver_7b26a5b0(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_googleanalytics_4f1a8cac === 'function') {
    await nuxt_plugin_googleanalytics_4f1a8cac(app.context, inject)
  }
